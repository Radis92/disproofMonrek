...
<div class="wrapper">
 ...
 @include('layouts.includes._sidebar')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="https://pro.bricm.co">BRICASH</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="{{asset('plugi_ns/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
<!-- jQuery Knob Chart -->
